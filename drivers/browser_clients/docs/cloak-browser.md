...
You install → pip install cloakbrowser or npm install cloakbrowser
First launch → binary auto-downloads for your platform (Chromium 146)
...
Platform	Example
AWS Lambda	aws_lambda/ — One-shot scrapes in Lambda (container image)
Platforms
