...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1779829145);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1779829145);
user_pref("app.update.lastUpdateTime.region-update-timer", 1779829145);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1779829145);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1779829145);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "standard");
user_pref("browser.download.viewableInternally.typeWasRegistered.avif", true);
user_pref("browser.download.viewableInternally.typeWasRegistered.webp", true);
user_pref("browser.migration.version", 150);
user_pref("browser.newtabpage.activity-stream.impressionId", "{9924ae46-5814-46e4-9f0f-557643b57107}");
...
user_pref("browser.startup.lastColdStartupCheck", 1779831871);
...
user_pref("captchadetection.lastSubmission", 1779829);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECOP2U2DEKuGMBAhFdgAXGF7OhQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"b8513e5b-d690-49da-a16d-7cad9bcc5ead\",\"pictureinpicture@mozilla.org\":\"b39fe368-789a-4d69-86a8-3610c9c329e9\",\"screenshots@mozilla.org\":\"227ed539-b723-43b7-a3dc-f679784363dd\",\"webcompat@mozilla.org\":\"d73ba7b9-aa30-4883-aa9c-c2637535df89\",\"firefox-compact-dark@mozilla.org\":\"59e42058-62e2-4c7b-932f-cf50b2cedc2c\",\"addons-search-detection@mozilla.com\":\"3515cb42-96fe-4238-ab2f-e7e7241e4df1\",\"uBlock0@raymondhill.net\":\"451035f8-740c-41c1-9a23-512c9b9dabe2\"}");
...
user_pref("media.gmp-manager.lastCheck", 1779829152);
user_pref("media.gmp-manager.lastEmptyCheck", 1779829152);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECK4AIC3cRru0BAjPVZ1cKvPCLw==");
user_pref("toolkit.startup.last_success", 1779831857);
